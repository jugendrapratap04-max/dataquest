...
**17 written, 65 problems.** Read that file before touching this subject.
...
standard, so the whole subject is in one shape and **lesson 18 ("Logical,
compare and rotate") is next in Chapter 4**. Thirty panels were built across those
thirteen lessons, and what they teach is the part worth copying: each one carries an
