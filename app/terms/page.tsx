...
export const metadata: Metadata = {
  title: "Terms of Service — DataMarg",
  description: "The terms you agree to when you use DataMarg.",
};
  ...
  return (
    <LegalShell title="Terms of Service" current="/terms">
      <p className="legal-lead">
        These are the terms you agree to by using DataMarg. They are written to be read, not to be
        skipped.
      </p>

      <h2>1. Who can use DataMarg</h2>
      <p>
        DataMarg is meant for learners aged 16 and over. If you are under 18, you may use it only
      ...
      <p>
        ...
        the law while using DataMarg. You are responsible for what you say, type, submit and share,
        including everything you say in a voice study room.
      </p>

      <h2>4. What DataMarg is, and is not</h2>
      <p>
        DataMarg gives you lessons, a code editor, practice problems and tools for studying with
      ...
      <p>
        DataMarg is a young platform running on free infrastructure. It may be slow, may be down,
        and features may change or be removed. We do not promise uninterrupted service.
      </p>

      <h2>8. Liability</h2>
      <p>
        To the extent the law allows, DataMarg is provided as it is. We are not liable for loss you
      ...
      <p>
        ...
        to use DataMarg after a change means you accept the updated terms.
      </p>
