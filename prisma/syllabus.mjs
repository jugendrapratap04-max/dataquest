...
export const SYLLABUS = [
  ...
  { group: "DSA — algorithm design", topics: [
    ...
    { t: "Dynamic programming", covers: ["dynamic-programming-knapsack"] },
    { t: "Greedy algorithms", covers: ["greedy-algorithms"] },
  ...
  { group: "Beyond W3Schools (our own edge)", topics: [
    ...
    { t: "Why value-per-kilo greedy is wrong for 0/1 knapsack", covers: ["dynamic-programming-knapsack"] },
