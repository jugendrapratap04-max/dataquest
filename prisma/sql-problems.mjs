...
const sqlProblems = [
  ...
  SQ("sql-intro", "Easy", 2, "sql-select-cols", "Sirf Naam aur Salary",
  ...
  SQ("sql-intro", "Easy", 3, "sql-select-dept", "Departments ki List",
  ...
  /* ---------- WHERE ---------- */
  SQ("sql-where", "Easy", 4, "sql-where-salary", "80k se Zyada Kamane Wale",
  ...
  SQ("sql-where", "Easy", 5, "sql-where-city", "Mumbai ka Department",
  ...
  SQ("sql-where", "Medium", 6, "sql-where-year", "2022 me Joined",
  ...
  SQ("sql-order", "Easy", 7, "sql-order-salary", "Salary ke Hisaab se Sort",
  ...
  /* ---------- GROUP BY ---------- */
  SQ("sql-groupby", "Medium", 10, "sql-count-by-dept", "Har Department me Kitne Log",
  ...
  SQ("sql-groupby", "Medium", 11, "sql-avg-salary", "Department ki Average Salary",
  ...
  /* ---------- JOINS ---------- */
  SQ("sql-joins", "Medium", 13, "sql-join-basic", "Employee ka Department",
  ...
  SQ("sql-joins", "Medium", 14, "sql-join-city", "Bengaluru ki Team",
  ...
  SQ("sql-joins", "Hard", 15, "sql-left-join", "Khaali Department",
  ...
  /* ---------- SUBQUERIES / WINDOW ---------- */
  SQ("sql-advanced", "Hard", 16, "sql-subquery-avg", "Average se Upar",
  ...
  SQ("sql-advanced", "Hard", 17, "sql-window-rank", "Department me Rank",
