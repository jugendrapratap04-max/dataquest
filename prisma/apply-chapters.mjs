...
const PLANS = {
  ...
  python: [
    ...
    { slug: "py-dsa", title: "Data structures & algorithms", upto: 54, summary: "Big-O, stacks and queues, linked lists and hash tables, trees and graphs, searching and sorting, the Python reference, the three tree traversals, balanced trees, sorting without comparing, the three linked-list shapes with hash sets, cycle detection, shortest paths, and minimum spanning trees." },
  ],
