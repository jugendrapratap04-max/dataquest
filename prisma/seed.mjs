...
/* ------------------------------------------------------------------ */
const tracks = [
  { slug: "python", order: 1, title: "Programming Foundations — Python", subtitle: "the base of everything", icon: "Py", status: "done", weeks: "~4 weeks", level: "Beginner",
    ...
    skillsJson: JSON.stringify([["Variables, data types, operators",1],["If-else, loops",1],["Functions & scope",1],["List, tuple, dict, set",1],["String methods & slicing",1],["Comprehensions",1],["OOP — classes, inheritance",1],["Error handling",1],["File handling",1],["Modules, pip, venv",1]]) },
  { slug: "statistics", order: 2, title: "Math & Statistics", subtitle: "the brain behind ML", icon: "∑", status: "done", weeks: "~5 weeks", level: "Beginner→Inter",
    ...
    skillsJson: JSON.stringify([["Descriptive stats",1],["Probability & Bayes",1],["Distributions",1],["CLT & sampling",1],["Hypothesis testing, p-value",1],["Chi-square & ANOVA",1],["Correlation vs causation",1],["A/B testing",1],["Linear algebra basics",1],["Calculus intuition",1]]) },
  { slug: "pandas", order: 3, title: "Data Manipulation — NumPy & Pandas", subtitle: "the daily job of a data pro", icon: "pd", status: "now", weeks: "~4 weeks", level: "Intermediate",
    ...
    skillsJson: JSON.stringify([["NumPy arrays & vectorization",1],["Series & DataFrame",1],["Read CSV/Excel/JSON/SQL",1],["Indexing (loc/iloc)",1],["Missing data (NaN)",1],["GroupBy & aggregation",1],["Merge, join, concat",0],["Pivot & reshape (melt)",0],["Apply, map, lambda",0],["Cleaning: dupes, outliers, dtypes",0]]) },
  { slug: "viz", order: 4, title: "Data Visualization & EDA", subtitle: "turn data into insight", icon: "Viz", status: "locked", weeks: "~3 weeks", level: "Intermediate",
    ...
    skillsJson: JSON.stringify([["Matplotlib",0],["Seaborn",0],["Plotly (interactive)",0],["EDA: uni/bi/multivariate",0],["Correlation heatmaps",0],["Data storytelling",0],["Excel / Sheets",0],["Right chart chunna",0]]) },
  { slug: "sql", order: 5, title: "SQL & Databases", subtitle: "every job asks for this", icon: "DB", status: "locked", weeks: "~4 weeks", level: "Intermediate",
    ...
    skillsJson: JSON.stringify([["SELECT, WHERE, ORDER BY",0],["Aggregations, GROUP BY",0],["Joins (inner/left/right)",0],["Subqueries & CTEs",0],["Window functions",0],["Date & string functions",0],["DB design & normalization",0],["Query optimization",0]]) },
  { slug: "bi", order: 6, title: "Business Intelligence & Dashboards", subtitle: "🎯 Data Analyst ready here", icon: "BI", status: "locked", weeks: "~3 weeks", level: "Intermediate",
    ...
    skillsJson: JSON.stringify([["Power BI or Tableau",0],["Data modeling",0],["DAX / calc fields",0],["Interactive dashboards",0],["KPIs & metrics",0],["Publishing reports",0]]) },
  { slug: "ml", order: 7, title: "Machine Learning", subtitle: "the core of 'Data Scientist'", icon: "ML", status: "locked", weeks: "~8 weeks", level: "Advanced",
    ...
    skillsJson: JSON.stringify([["ML workflow & scikit-learn",0],["Preprocessing: encoding, scaling",0],["Feature engineering",0],["Regression: Linear, Ridge, Lasso",0],["Classification: Logistic, KNN, SVM",0],["Trees & Random Forest",0],["Boosting: XGBoost, LightGBM",0],["Unsupervised: K-Means, PCA",0],["Evaluation: CV, ROC-AUC, RMSE",0],["Hyperparameter tuning",0]]) },
  { slug: "dl", order: 8, title: "Deep Learning & a Specialization", subtitle: "pick ONE, go deep", icon: "DL", status: "locked", weeks: "~8 weeks", level: "Advanced",
    ...
    skillsJson: JSON.stringify([["Neural network basics",0],["TensorFlow/Keras or PyTorch",0],["CNN — vision basics",0],["RNN / LSTM",0],["NLP: TF-IDF, embeddings",0],["Transformers / BERT intro",0],["Time series: ARIMA, Prophet",0],["Master 1 specialization",0]]) },
  { slug: "deploy", order: 9, title: "Deployment, Portfolio & Job Prep", subtitle: "🚀 Data Scientist ready here", icon: "★", status: "locked", weeks: "~6 weeks", level: "Advanced",
    ...
    skillsJson: JSON.stringify([["Git & GitHub",0],["Deploy: Flask/FastAPI/Streamlit",0],["Docker basics",0],["Cloud intro (AWS/GCP)",0],["PySpark / big data (bonus)",0],["Portfolio: 3-4 projects + Kaggle",0],["Resume & LinkedIn",0],["Interview prep: SQL, ML, stats",0],["Communication & business sense",0],["Mock interviews & apply",0]]) },
];
