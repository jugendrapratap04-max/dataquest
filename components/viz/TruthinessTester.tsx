...
const VALUES: V[] = [
  ...
  { code: "None", truthy: false, why: "None — always falsy" },
  { code: "1", truthy: true, why: "any non-zero number — truthy" },
  { code: "-5", truthy: true, why: "non-zero, negatives included — truthy" },
  { code: '"hi"', truthy: true, why: "non-empty string — truthy" },
  { code: '" "', truthy: true, why: "a space is still a character — truthy!" },
